...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.activityWebViewBtn).setOnClickListener(this);

        mTextView = (TextView) findViewById(R.id.textToBeChanged);
        mEditText = (EditText) findViewById(R.id.editTextUserInput);
        String text = PreferenceManager.getDefaultSharedPreferences(this).getString("key", "");
        Log.w("KST", "Test String " + text);
        PreferenceManager.getDefaultSharedPreferences(this).edit().putString("key", UUID.randomUUID().toString()).commit();
    }
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == R.id.activityWebViewBtn) {
            startActivity(WebViewActivity.newStartIntent(this));
        }
    }
}
